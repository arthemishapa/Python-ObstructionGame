...
class SevenNineBoard(Frame):
    def __init__(self, parent, controller, ai):
        ...
        self.Button_seven = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                              disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black", relief=SUNKEN,
                              height=2, width=5, pady="0", padx="0",
        ...
        self.Button_eight = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                              disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black", relief=SUNKEN,
                              height=2, width=5, pady="0", padx="0",
                              command=lambda: self.make_move(0, 7, self.Button_eight, self.Button_seven,
                                                             self.Button_thirteen, self.Button_fourteen,
                                                             self.Button_eight2, self.Button_fourteen2))
        self.Button_eight.grid(row=0, column=7)

        self.Button_eight2 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                                   disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                   relief=SUNKEN,
                                   height=2, width=5, pady="0", padx="0",
                                   command=lambda: self.make_move(0, 8, self.Button_eight2,
                                                                  self.Button_fourteen2, self.Button_fourteen,
                                                                  self.Button_eight))
        self.Button_eight2.grid(row=0, column=8)
        ...
        self.Button_thirteen = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button_fourteen = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
                               command=lambda: self.make_move(1, 7, self.Button_fourteen, self.Button_seven,
                                                              ...
                                                              self.Button_eight2, self.Button_fourteen2, self.Button_twenty2))
        self.Button_fourteen.grid(row=1, column=7)

        self.Button_fourteen2 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                                      background="#ffffff",
                                      disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                      relief=SUNKEN,
                                      height=2, width=5, pady="0", padx="0",
                                      command=lambda: self.make_move(1, 8, self.Button_fourteen2, self.Button_eight2,
                                                                     self.Button_eight, self.Button_twenty2,
                                                                     self.Button_fourteen, self.Button_twenty))
        self.Button_fourteen2.grid(row=1, column=8)
        ...
        self.Button_nineteen = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button_twenty = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
                               command=lambda: self.make_move(2, 7, self.Button_twenty, self.Button_nineteen,
                                                              ...
                                                              self.Button_twentysix2, self.Button_fourteen2, self.Button_twenty2))
        self.Button_twenty.grid(row=2, column=7)

        self.Button_twenty2 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                                    disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                    relief=SUNKEN,
                                    height=2, width=5, pady="0", padx="0",
                                    command=lambda: self.make_move(2, 8, self.Button_twenty2, self.Button_twenty,
                                                                   self.Button_twentysix2, self.Button_fourteen2,
                                                                   self.Button_fourteen, self.Button_twentysix))
        self.Button_twenty2.grid(row=2, column=8)
        ...
        self.Button_twentyfive = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button_twentysix = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
                               command=lambda: self.make_move(3, 7, self.Button_twentysix, self.Button_nineteen, self.Button_twenty,
                                                              ...
                                                              self.Button_thirytwo2, self.Button_twenty2, self.Button_twentysix2))
        self.Button_twentysix.grid(row=3, column=7)

        self.Button_twentysix2 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                                       background="#ffffff",
                                       disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                       relief=SUNKEN,
                                       height=2, width=5, pady="0", padx="0",
                                       command=lambda: self.make_move(3, 8, self.Button_twentysix2, self.Button_twenty2,
                                                                      self.Button_twenty,
                                                                      self.Button_twentysix, self.Button_thirytwo2,
                                                                      self.Button_thirytwo))
        self.Button_twentysix2.grid(row=3, column=8)
        ...
        self.Button_thirtyone = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button_thirytwo = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
                               command=lambda: self.make_move(4, 7, self.Button_thirytwo, self.Button_twentysix, self.Button_twentyfive,
                                                              ...
                                                              self.Button_twentysix2, self.Button_thirytwo2, self.Button_thirtyeight2))
        self.Button_thirytwo.grid(row=4, column=7)

        self.Button_thirytwo2 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                                      background="#ffffff",
                                      disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                      relief=SUNKEN,
                                      height=2, width=5, pady="0", padx="0",
                                      command=lambda: self.make_move(4, 8, self.Button_thirytwo2, self.Button_twentysix,
                                                                     self.Button_twentysix2, self.Button_thirytwo,
                                                                     self.Button_thirtyeight, self.Button_thirtyeight2))
        self.Button_thirytwo2.grid(row=4, column=8)
        ...
        self.Button_thirtyseven = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button_thirtyeight = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
                               command=lambda: self.make_move(5, 7, self.Button_thirtyeight, self.Button45,
                                                              self.Button_thirytwo, self.Button46, self.Button462,
                                                              self.Button_thirtyone, self.Button_thirtyseven,
                                                              self.Button_thirtyeight2, self.Button_thirytwo2))
        self.Button_thirtyeight.grid(row=5, column=7)

        self.Button_thirtyeight2 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                                         background="#ffffff",
                                         disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                         relief=SUNKEN,
                                         height=2, width=5, pady="0", padx="0",
                                         command=lambda: self.make_move(5, 8, self.Button_thirtyeight2, self.Button462,
                                                                        self.Button_thirytwo, self.Button46,
                                                                        self.Button_thirtyeight, self.Button_thirytwo2))
        self.Button_thirtyeight2.grid(row=5, column=8)

        """ROW 6"""

        self.Button39 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button40 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button41 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button42 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button43 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button44 = Button(self, activebackground="#d9d9d9", activeforeground="#000000", background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
        ...
        self.Button45 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                                         background="#ffffff",
                                         disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                         relief=SUNKEN,
                                         height=2, width=5, pady="0", padx="0",
        ...
        self.Button46 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                                         background="#ffffff",
                                         disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                                         relief=SUNKEN,
                                         height=2, width=5, pady="0", padx="0",
                                         command=lambda: self.make_move(6, 7, self.Button46, self.Button_thirtyeight,
                                                                        ...
                                                                        self.Button_thirtyeight2, self.Button462))
        self.Button46.grid(row=6, column=7)

        self.Button462 = Button(self, activebackground="#d9d9d9", activeforeground="#000000",
                               background="#ffffff",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightcolor="black",
                               relief=SUNKEN,
                               height=2, width=5, pady="0", padx="0",
                               command=lambda: self.make_move(6, 8, self.Button462, self.Button_thirtyeight,
                                                              self.Button_thirtyeight2, self.Button46))
        self.Button462.grid(row=6, column=8)

        self.button_array = {}
        iterate = 0
        for but in (self.Button1, self.Button2, self.Button3, self.Button4, self.Button5, self.Button6,
                    self.Button_seven, self.Button_eight, self.Button_eight2, self.Button7,
                    self.Button8, self.Button9, self.Button10, self.Button11, self.Button12,
                    self.Button_thirteen, self.Button_fourteen,self.Button_fourteen2, self.Button13, self.Button14,
                    self.Button15, self.Button16, self.Button17, self.Button18,
                    self.Button_nineteen, self.Button_twenty, self.Button_twenty2, self.Button19, self.Button20,
                    self.Button21, self.Button22, self.Button23, self.Button24,
                    self.Button_twentyfive, self.Button_twentysix,self.Button_twentysix2, self.Button25, self.Button26,
                    self.Button27, self.Button28, self.Button29, self.Button30,
                    self.Button_thirtyone, self.Button_thirytwo, self.Button_thirytwo2, self.Button31, self.Button32,
                    self.Button33, self.Button34, self.Button35, self.Button36,
                    self.Button_thirtyseven, self.Button_thirtyeight,self.Button_thirtyeight2, self.Button39, self.Button40, self.Button41,
                    self.Button42, self.Button43, self.Button44, self.Button45, self.Button46, self.Button462):
            self.button_array[iterate] = but
            iterate += 1

        fill_in = Button(self, borderwidth="0")
        fill_in.grid(row=0, column=9)
        lbl_info = Label(self, font=('terminal', 15, 'bold'), text="7x9 Board", anchor='w')
        lbl_info.grid(row=0, column=10)
        self.ButtonQuit = Button(self, background="#DA2C43", text="Quit", height=2, width=5,
                                 command=lambda: self.quit())
        self.ButtonQuit.grid(row=2, column=10)
        self.ButtonReset = Button(self, background="light green", text="Reset", height=2, width=5,
                                  command=lambda: self.reset_game())
        self.ButtonReset.grid(row=1, column=10)

    def create_board(self):
        self.__ai.set_row(7)
        self.__ai.set_column(9)
    ...
    def first_ai(self):
        ...
        index = point.get_x() * 9 + point.get_y()
